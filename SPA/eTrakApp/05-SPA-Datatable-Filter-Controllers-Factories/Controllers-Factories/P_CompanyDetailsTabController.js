...
eTrakApp.controller('P_CompanyDetailsTab', ['$q', '$scope', '$rootScope','$stateParams', '$timeout', 'logger', 'R_EnquiriesService', controller]);
...
function controller($q, $scope, $rootScope,$stateParams, $timeout, logger, enquiryDataservice) {
   ...
   // var userId = $('#idglbMainUserID').val();
    ...
    function doBreadcrumbs() {
        ...
        $rootScope.breadcrumbsValueAreHere = '> Company Details';
