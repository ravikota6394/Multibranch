(function () {
    ...
    eTrakApp.controller('P_EnquiryHistoryTab', ['$q', '$scope', '$rootScope', '$stateParams', '$timeout', 'logger', 'R_EnquiriesService', controller]);
    ...
    function controller($q, $scope, $rootScope, $stateParams, $timeout, logger, enquiryDataservice) {
        ...
        function doBreadcrumbs() {
            ...
            $rootScope.breadcrumbsValueAreHere = '> Enquiry History';
